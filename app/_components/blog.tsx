...
export function Blog() {
    return (
        <section className="overflow-hidden text-gray-700 bg-white flex justify-center items-center px-10 py-20 text-center">
            <div>
                <h2 className="text-4xl text-center md:text-5xl lg:text-6xl font-bold white pb-15" >Nosso blog</h2>
