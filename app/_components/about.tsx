...
export function About() {
    return (
        <section id="about" className="overflow-hidden bg-amber-50 flex flex-col justify-center items-center py-20 px-10">
            <div className="md:max-w-200 flex flex-col items-center">
                <h2 className="text-4xl text-center md:text-5xl lg:text-6xl font-bold text-gray-700 pb-8" data-aos="zoom-in-up">Nossa abordagem</h2>
                ...
                <button className="bg-amber-600 py-4 px-10 hover:scale-105 hover:brightness-110 duration-300" data-aos="zoom-in-up"> 
                    <a target="_blank" href="https://wa.me/556799998800?text=Olá, Mariana, tudo bem? Vim pela landing page de saúde mental, Mentis, desenvolvida por você.">SAIBA MAIS</a>
                </button>
            </div>
            ...
            <div className="md:max-w-300 pt-10 sm:pt-20 flex flex-col justify-center items-center gap-10 sm:flex-row">
                ...
                <div className="max-w-140">
                    <h2 className="text-4xl text-center sm:text-start md:text-5xl font-bold text-gray-700 pb-5" data-aos="zoom-in-up">Disponibilizamos um espaço seguro e confortável</h2>
            ...
            <div className="md:max-w-300 pt-10 sm:pt-20 flex flex-col justify-center items-center gap-10 sm:flex-row-reverse">
                ...
                <div className="max-w-140">
                    <h2 className="text-4xl text-center sm:text-start md:text-5xl font-bold text-gray-700 pb-5" data-aos="zoom-in-up">Opções presenciais e remotas</h2>
